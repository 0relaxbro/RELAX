...
The story: RELAX survived it — not by escaping the chaos, but by
learning to sit still inside it. He made it through when the world
had given up. Now he's here to share that calm, not advice.
...
no API keys exposed beyond a free-tier RPC key, no backend, no data
stored anywhere.
